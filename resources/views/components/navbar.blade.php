    ...
    <div class="mx-auto w-[92%] max-w-[1200px] py-3">
      ...
      <div class="flex items-center justify-between gap-4">
        ...
        <nav class="hidden items-center gap-5 text-[14px] lg:flex">
          ...
          <a class="hover:text-slate-950 {{ $isActive('home') }}"
             href="{{ route('home') }}">
             {{ __('messages.nav.home') }}
          </a>

          <a class="hover:text-slate-950 {{ $isActive('services') }}"
             href="{{ route('services') }}">
             {{ __('messages.nav.services') }}
          </a>

          <a class="hover:text-slate-950 {{ $isActive('products.index') }}"
             href="{{ route('products.index') }}">
             {{ __('messages.nav.products') }}
          </a>

          <a class="hover:text-slate-950 {{ $isActive('publications.*') }}"
             href="{{ route('publications.index') }}">
             {{ __('messages.nav.publications') }}
          </a>

          <a class="hover:text-slate-950 {{ $isActive('about') }}"
             href="{{ route('about') }}">
             {{ __('messages.nav.about') }}
          </a>

          <a class="hover:text-slate-950 {{ $isActive('contact') }}"
             href="{{ route('contact') }}">
