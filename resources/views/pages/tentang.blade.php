  ...
  <div class="max-w-6xl mx-auto px-6 pt-10 pb-0">
    ...
    <div class="flex items-center gap-5 mb-7">
      ...
      <p class="text-[20px] font-medium text-slate-300">
        {{ __('Professional Solution for Your Business') }}
      </p>
    </div>
    ...
    <div class="flex flex-col lg:flex-row gap-14 items-start">
      ...
      <div class="w-full lg:flex-1">
        ...
        <p class="text-[13px] leading-[1.8] text-[#5e5b5b] w-full">
          {{ __('Menjadi perusahaan teknologi informasi terpercaya yang menghadirkan solusi digital inovatif, berkualitas tinggi, dan berkelanjutan untuk membantu bisnis berkembang serta beradaptasi di era transformasi digital.') }}
        </p>
      </div>
