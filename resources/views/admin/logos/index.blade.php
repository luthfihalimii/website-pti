    ...
    <div class="bg-white border rounded-2xl p-6 shadow-sm">
        ...
        <div class="flex flex-col md:flex-row items-center gap-6">
            <div class="flex justify-center items-center h-24 w-24 border rounded-xl bg-slate-50 p-2">
                @if($pti && $pti->path)
                    <img src="{{ asset('storage/'.$pti->path) }}"
            ...
            <form action="{{ route('admin.logos.update', $pti) }}"
                ...
                <label class="flex items-center gap-3 cursor-pointer">
                    ...
                    <span id="file-pti" class="text-sm text-slate-600"></span>
    ...
    <div class="bg-white border rounded-2xl p-6 shadow-sm">
        ...
        <div class="grid md:grid-cols-2 gap-5">
            ...
            <div class="border rounded-xl p-4 bg-slate-50 space-y-3">
                ...
                <form action="{{ route('admin.logos.destroy',$c) }}"
                      method="POST"
                      class="w-1/2">
                    @csrf
                    @method('DELETE')
            ...
            @empty
                <p class="text-sm text-slate-400 col-span-2">
    ...
    <div class="bg-white border rounded-2xl p-6 shadow-sm">
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-5">
            ...
            <div class="border rounded-xl p-4 bg-slate-50 space-y-3 text-center">
                ...
                <form action="{{ route('admin.footer.upload') }}"
                      method="POST"
                      enctype="multipart/form-data">
                    @csrf
                ...
                @if($logo)
                <form action="{{ route('admin.footer.destroy',$logo->id) }}"
                      method="POST">
                    @csrf
                    @method('DELETE')
